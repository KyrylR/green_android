...
import com.blockstream.common.walletabi.transport.WalletAbiTxCreateRequest
 ...
 data class WalletAbiImpactPreviewRequest(
 ...
 data class WalletAbiImpactPreviewResult(
 ...
 interface WalletAbiImpactPreviewing {
    suspend fun preview(request: WalletAbiImpactPreviewRequest): WalletAbiImpactPreviewResult
}

 class NoopWalletAbiImpactPreviewer : WalletAbiImpactPreviewing {
